<div style="background-color: rgba(122, 238, 238, 0.5); padding: 20px; border-radius: 15px; transform: rotate3d(4);">
    ...
    <table align="center" style="width: 100%; color: #000; font-weight: bold;">
      <tr>
        <th style="color: blue;">Current Learning</th>
        <td style="font-style: italic;">Database, DL, ML</td>
      </tr>
      <tr>
        <th style="color: blue;">Collaboration</th>
        <td style="font-style: italic;">AI members</td>
      </tr>
      <tr>
        <th style="color: blue;">Help</th>
        <td style="font-style: italic;">AI</td>
      </tr>
      <tr>
        <th style="color: blue;">Projects</th>
        <td style="font-style: italic;">
          <a href="https://github.com/Chavdadhruv" style="color: #4CAF50;">All of my projects</a>
        </td>
      </tr>
      <tr>
        <th style="color: blue;">Articles</th>
        <td style="font-style: italic;">
          <a href="artificial intelligence" style="color: #4CAF50;">Artificial Intelligence</a>
        </td>
      </tr>
      <tr>
        <th style="color: blue;">Ask me about</th>
        <td style="font-style: italic;">Data Science</td>
      </tr>
      <tr>
        <th style="color: blue;">Contact</th>
        <td style="font-style: italic;">dhruvchavda447@gmail.com</td>
      </tr>
    </table>
